...
namespace MG.SharePoint
{
    ...
    {
        public static bool IsLoaded(this Web web)
        {
            return web.IsPropertyReady(w => w.Alerts.Include(a => a.Title), w => w.AllowAutomaticASPXPageIndexing, w => w.AllowCreateDeclarativeWorkflowForCurrentUser,
